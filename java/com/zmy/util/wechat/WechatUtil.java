...
/**
*@author 作者：张哥哥
*@version 创建时间：2019年4月22日上午12:21:10
*Class Description： 主要用来提交https请求给微信获取用户信息
*/
public class WechatUtil {
    ...
    public static UserAccessToken getUserAccessToken(String code) throws IOException {
        // 测试号信息里的appId
        String appId = "wxddf2814d13159239";
        log.debug("appId:" + appId);
        // 测试号信息里的appsecret
        String appsecret = "9dfc3f3e4cea2f092c5cc04b3f167379";
